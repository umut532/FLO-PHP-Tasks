  ...
  elseif(empty($password)){
      echo("<div class='alert'><center>Lütfen şifrenizi giriniz Giriniz.</b></center></div>");
          ...
          $state=null;
              ...
              {
                  if ($userName == $value['user-name'] && $passwordSha1 == $value["password"]) {
                      $state=true;
                  }
                  else {
                      $state=false;
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">yavs</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Yönetim Paneline Hoşgeldin! 👋</h4>
              <p class="mb-4">Lütfen tarafınıza verilmiş bilgiler ile giriş yapın</p>
              ...
              <form action="" class="form" method="post">
                    ...
                    <div class="mb-3">
                    <button class="btn btn-primary d-grid w-100" name="submit" type="submit">Giriş Yap</button>
                    </div>
              </form>
              </div>
